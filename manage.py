...
from skippy.app import create_app
from skippy.database import db
from skippy.settings import DevConfig, ProdConfig
from skippy.user.models import User

CONFIG = ProdConfig if os.environ.get('SKIPPY_ENV') == 'prod' else DevConfig
